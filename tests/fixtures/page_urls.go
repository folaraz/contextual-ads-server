...
var PageURLPool = map[string][]string{
	...
	"lifestyle": {
		...
		"https://en.wikipedia.org/wiki/Wristwatch",
		...
		"https://zenhabits.net/start/",
	},

	"music": {
		"https://en.wikipedia.org/wiki/Music_streaming",
	...
	"movies": {
		...
		"https://en.wikipedia.org/wiki/Television_series",
	...
	"gaming": {
		...
		"https://www.polygon.com/what-to-play",
		"https://kotaku.com/",
	},
	...
	"finance": {
		...
		"https://en.wikipedia.org/wiki/Vanguard_Group",
	...
	"basketball": {
		...
		"https://en.wikipedia.org/wiki/Spalding_(company)",
		...
		"https://en.wikipedia.org/wiki/Basketball_shoe",
	...
	"football": {
		...
		"https://en.wikipedia.org/wiki/Riddell",
		"https://en.wikipedia.org/wiki/NFL_Combine",
		...
		"https://www.nike.com/football",
		"https://www.nfl.com/watch",
	...
	"tennis": {
		...
		"https://en.wikipedia.org/wiki/Tennis_racket",
		...
		"https://en.wikipedia.org/wiki/Doubles_(tennis)",
	...
	"sports": {
		...
		"https://en.wikipedia.org/wiki/Callaway_Golf",
		"https://en.wikipedia.org/wiki/Titleist",
		"https://en.wikipedia.org/wiki/Olympic_Games",
		"https://en.wikipedia.org/wiki/Fanatics_(company)",
		"https://en.wikipedia.org/wiki/Sports_memorabilia",
		...
		"https://en.wikipedia.org/wiki/Extreme_sports",
	...
	"automotive": {
		...
		"https://en.wikipedia.org/wiki/Car_lease",
	...
	"politics": {
		...
		"https://en.wikipedia.org/wiki/Immigration_policy",
	...
	"pets": {
		...
		"https://en.wikipedia.org/wiki/Petco",
	...
	"home": {
		...
		"https://en.wikipedia.org/wiki/Crate_%26_Barrel",
	...
	"education": {
		...
		"https://en.wikipedia.org/wiki/MasterClass_(online_classes)",
	...
	"food": {
		...
		"https://en.wikipedia.org/wiki/HelloFresh",
	...
	"health": {
		...
		"https://en.wikipedia.org/wiki/ClassPass",
		...
		"https://en.wikipedia.org/wiki/Teladoc_Health",
	...
	"b2b": {
		...
		"https://en.wikipedia.org/wiki/Okta_(identity_management)",
	...
	"e-commerce": {
		...
		"https://en.wikipedia.org/wiki/Wireless_headphones",
	...
	"blog": {
		...
		"https://en.wikipedia.org/wiki/Side_project",
	...
	"entertainment": {
		"https://en.wikipedia.org/wiki/Pop_culture",
		...
		"https://en.wikipedia.org/wiki/Theme_park",
...
func AllPageURLs() []string {
	var urls []string
	for _, categoryURLs := range PageURLPool {
		urls = append(urls, categoryURLs...)
	}
	return urls
}

func GetPageURLsByCategory(category string) []string {
	if urls, ok := PageURLPool[category]; ok {
		return urls
	}
	return PageURLPool["news"]
}

func CategoryCount() int {
	return len(PageURLPool)
}

func TotalURLCount() int {
	count := 0
	for _, urls := range PageURLPool {
		count += len(urls)
	}
	return count
}
